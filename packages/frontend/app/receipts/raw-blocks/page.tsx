...
export default function RawBlockReceiptsPage() {
  ...
  return (
    <div className="app-shell">
      ...
      <Ticket icon={PackagePlus} title="Receive Blocks" subtitle="Enter the blocks physically received today. Stock history is recorded automatically.">
        <div className="grid">
        ...
        <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 12 }}>
          <button className="mini-btn" onClick={() => { setLines([...lines, line]); setLine({ ...line, serialNumber: "", varietyName: "", weightTons: "" }); }}><Plus size={14} /> Add another block</button>
          <button className="primary-btn" onClick={submit}><Send size={14} /> Receive blocks</button>
        </div>
      </Ticket>
